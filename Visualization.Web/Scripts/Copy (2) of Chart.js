...
//    }
    ...
    var CreateBarGraph = function () {
        ...
        jQuery.ajax({
            type: "GET",
            url: "../HttpHandler/MessageHandler.ashx?operation=BarGraph&nodeType=" + event + "&id=" + eAttr + "&attributeType=" + eAttrSub + "&ts="+ts,
            success: RefreshBarGraph,
            error: errorFn
        });
    };
    ...
    $(document).ready(function () {
        ...
        window.setTimeout(CreateBarGraph, 150);        
    });
